...
function ContactDrawer({ open, onClose, contact, agents, onSave }) {
  ...
  React.useEffect(() => { setForm(contact || blank); setErrors({}) }, [contact, open])
  ...
  return (
    <Drawer open={open} onClose={onClose} title={contact?.id ? 'Edit Contact' : 'Add Contact'} width={480}>
...
export default function ContactsPage({ db, setDb, activeAgent, go, openCompose }) {
  ...
  return (
    <div className="page-content">
      ...
      <ContactDrawer open={drawer} onClose={() => setDrawer(false)} contact={editing} agents={agents} onSave={reload} />
