 ...
 * Mirrors the dark premium style of LandingMultifamily.
 *
 * landing_config shape (same as multifamily CollageBuilder with variant="valuation"):
 *   { headline, subheadline, images[{url,units,price}], highlights[], cta_text, accent }
 */
...
export default function LandingValuation({ mailingId }) {
  ...
  if (error && !mailing) return (
    <div style={{ ...pageSt, padding:60, textAlign:'center' }}>
      <div style={{ fontFamily:'Cormorant Garamond, serif', fontSize:18, color:'#f3f0e6' }}>Gateway Real Estate</div>
